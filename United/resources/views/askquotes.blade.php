...
@section('content')
<div class="aas">
<svg version="1.1" id="home-anim" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1820 1080" style="height:900px;enable-background:new 0 0 1820 1080;" xml:space="preserve">
<g id="home">
	<defs>
		<rect id="masque" y="0.4" width="100%" height="1500px"/>
	</defs>
	<clipPath id="cache">
...
<div class="container-fluid centered">
	<div class="container">
		<h2 style="padding-bottom: 5%;">Ask Quote</h2>
		<div class="row">
			<div class="col-md-3">
			</div>
			<div class="col-md-6 ">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="form-element">
					<textarea name="message" class="form-element" placeholder="Type Message" rows="5" style="
					width: 100%;border:3px dotted #4C1C8A;border-radius: 8px;"></textarea>
				</div>
			</div>
			<div class="col-md-3">
			</div>
		...
		<div class="row">
			...
			<div class="col-md-3">
				<div class="nav-button " style="padding:20% 0;">
					<ul>
						<li>View More</li>
